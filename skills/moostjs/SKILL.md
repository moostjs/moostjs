...
| --------------------------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Core concepts, Moost class, lifecycle, registration, app init/dispose | [core.md](references/core.md)                                | New project, multi-adapter setup, `app.init()`, `@MoostInit`/`@InjectMoost`, boot-time setup, Moost subclass, `app.dispose()`/`@MoostDispose`, graceful shutdown, resources leaking across hot reloads                                                                                                                                                                                                                                               |
