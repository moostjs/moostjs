    ...
    <template #home-hero-before>
        <div class="VPHero">
            <div class="container" style="display: flex; flex-direction: column;">
                <div class="main">
                    <img src="/moost-full-logo.png" alt="Moost" style="width: 400px; margin-bottom: 32px;" />
                    <p class="text">Metadata Driven Event Processing Framework</p>
                    <p class="tagline">Get the <strong style="color: #FF269B">moost</strong> out of your app.</p>  
