...
import type { TZodFunction, TZodMate } from './zod.mate'
...
export const Zod = (type: TZodMate['zodType']) => {
  ...
  const getZt = (opts?: TZodOpts) => (typeof type === 'function' ? type(opts) : type!)
 ...
 */
export const LazyType = <T extends TFunction | z.ZodType>(
  getter: () => T,
  opts?: Parameters<typeof z.lazy>[1]
) => Zod(_opts => z.lazy(() => toZodType(getter()), { ...opts, ..._opts }))
...
export const IsArray = (
  types?: (TFunction | z.ZodType | TPrimitives) | Array<TFunction | z.ZodType | TPrimitives>,
  opts?: { coerce?: true }
) => {
  const decorators = [ZodFn('IsArray', t => t.array()), mate.decorate('zodMarkedAsArray', true)]
  if (types) {
    if (Array.isArray(types)) {
      if (types.length > 1) {
        const zodType = z.union(
          types.map(t => toZodType(t, opts)) as [z.ZodTypeAny, z.ZodTypeAny, ...z.ZodTypeAny[]]
        )
 ...
 */
export const Refine = (...args: Parameters<ReturnType<typeof z.string>['refine']>) =>
  ZodFn('Refine', t => t.refine(...args))
 ...
 */
export const SuperRefine = (...args: Parameters<ReturnType<typeof z.string>['superRefine']>) =>
  ZodFn('SuperRefine', t => t.superRefine(...args))
 ...
 */
export const Transform = (...args: Parameters<ReturnType<typeof z.any>['transform']>) =>
  ZodFn('Transform', t => t.transform(...args))
 ...
 */
export const OnCatch = <Output>(
  def: ((ctx: { error: z.ZodError; input: unknown }) => Output) | Output
) =>
  ZodFn('OnCatch', t =>
    t.catch(...([def] as unknown as Parameters<ReturnType<typeof z.string>['catch']>))
  )
 ...
 */
export const HasLength = (...args: Parameters<ReturnType<typeof z.string>['length']>) =>
  ZodFn('HasLength', t => (t as z.ZodString).length(...args))

/**
 * Decorator to specify the minimum value for the Zod type
 * @param args - Arguments for the `min` method of Zod type
 */
export const Min = (...args: Parameters<ReturnType<typeof z.string>['min']>) =>
  ZodFn('Min', t => (t as z.ZodString).min(...args))

/**
 * Decorator to specify the maximum value for the Zod type
 * @param args - Arguments for the `max` method of Zod type
 */
export const Max = (...args: Parameters<ReturnType<typeof z.string>['max']>) =>
  ZodFn('Max', t => (t as z.ZodString).max(...args))

/**
 * Decorator to specify the minimum date for the Zod date type
 * @param args - Arguments for the `min` method of Zod date type
 */
export const DateFrom = (...args: Parameters<ReturnType<typeof z.date>['min']>) =>
  ZodFn('DateFrom', t => (t as z.ZodDate).min(...args))

/**
 * Decorator to specify the maximum date for the Zod date type
 * @param args - Arguments for the `max` method of Zod date type
 */
export const DateTo = (...args: Parameters<ReturnType<typeof z.date>['max']>) =>
  ZodFn('DateTo', t => (t as z.ZodDate).max(...args))
 ...
 */
export const IsEmail = (...args: Parameters<ReturnType<typeof z.string>['email']>) =>
  ZodFn('IsEmail', t => (t as z.ZodString).email(...args))
 ...
 */
export const IsUrl = (...args: Parameters<ReturnType<typeof z.string>['url']>) =>
  ZodFn('IsUrl', t => (t as z.ZodString).url(...args))
 ...
 */
export const IsEmoji = (...args: Parameters<ReturnType<typeof z.string>['emoji']>) =>
  ZodFn('IsEmoji', t => (t as z.ZodString).emoji(...args))
 ...
 */
export const IsUuid = (...args: Parameters<ReturnType<typeof z.string>['uuid']>) =>
  ZodFn('IsUuid', t => (t as z.ZodString).uuid(...args))
 ...
 */
export const IsCuid = (...args: Parameters<ReturnType<typeof z.string>['cuid']>) =>
  ZodFn('IsCuid', t => (t as z.ZodString).cuid(...args))
 ...
 */
export const IsCuid2 = (...args: Parameters<ReturnType<typeof z.string>['cuid2']>) =>
  ZodFn('IsCuid2', t => (t as z.ZodString).cuid2(...args))
 ...
 */
export const IsUlid = (...args: Parameters<ReturnType<typeof z.string>['ulid']>) =>
  ZodFn('IsUlid', t => (t as z.ZodString).ulid(...args))
 ...
 */
export const IsDatetime = (...args: Parameters<ReturnType<typeof z.string>['datetime']>) =>
  ZodFn('IsDatetime', t => (t as z.ZodString).datetime(...args))
 ...
 */
export const IsIp = (...args: Parameters<ReturnType<typeof z.string>['ip']>) =>
  ZodFn('IsIp', t => (t as z.ZodString).ip(...args))
 ...
 */
export const MatchesRegex = (...args: Parameters<ReturnType<typeof z.string>['regex']>) =>
  ZodFn('MatchesRegex', t => (t as z.ZodString).regex(...args))
 ...
 */
export const StartsWith = (...args: Parameters<ReturnType<typeof z.string>['startsWith']>) =>
  ZodFn('StartsWith', t => (t as z.ZodString).startsWith(...args))
 ...
 */
export const EndsWith = (...args: Parameters<ReturnType<typeof z.string>['endsWith']>) =>
  ZodFn('EndsWith', t => (t as z.ZodString).endsWith(...args))
 ...
 */
export const IsGt = (...args: Parameters<ReturnType<typeof z.number>['gt']>) =>
  ZodFn('IsGt', t => (t as z.ZodNumber).gt(...args))
 ...
 */
export const IsGte = (...args: Parameters<ReturnType<typeof z.number>['gte']>) =>
  ZodFn('IsGte', t => (t as z.ZodNumber).gte(...args))
 ...
 */
export const IsLt = (...args: Parameters<ReturnType<typeof z.number>['lt']>) =>
  ZodFn('IsLt', t => (t as z.ZodNumber).lt(...args))
 ...
 */
export const IsLte = (...args: Parameters<ReturnType<typeof z.number>['lte']>) =>
  ZodFn('IsLte', t => (t as z.ZodNumber).lte(...args))
 ...
 */
export const IsInt = (...args: Parameters<ReturnType<typeof z.number>['int']>) =>
  ZodFn('IsInt', t => (t as z.ZodNumber).int(...args))
 ...
 */
export const IsPositive = (...args: Parameters<ReturnType<typeof z.number>['positive']>) =>
  ZodFn('IsPositive', t => (t as z.ZodNumber).positive(...args))
 ...
 */
export const IsNonnegative = (...args: Parameters<ReturnType<typeof z.number>['nonnegative']>) =>
  ZodFn('IsNonnegative', t => (t as z.ZodNumber).nonnegative(...args))
 ...
 */
export const IsNegative = (...args: Parameters<ReturnType<typeof z.number>['negative']>) =>
  ZodFn('IsNegative', t => (t as z.ZodNumber).negative(...args))
 ...
 */
export const IsNonpositive = (...args: Parameters<ReturnType<typeof z.number>['nonpositive']>) =>
  ZodFn('IsNonpositive', t => (t as z.ZodNumber).nonpositive(...args))
 ...
 */
export const IsMultipleOf = (...args: Parameters<ReturnType<typeof z.number>['multipleOf']>) =>
  ZodFn('IsMultipleOf', t => (t as z.ZodNumber).multipleOf(...args))
 ...
 */
export const IsFinite = (...args: Parameters<ReturnType<typeof z.number>['finite']>) =>
  ZodFn('IsFinite', t => (t as z.ZodNumber).finite(...args))
 ...
 */
export const IsSafeNumber = (...args: Parameters<ReturnType<typeof z.number>['safe']>) =>
  ZodFn('IsSafeNumber', t => (t as z.ZodNumber).safe(...args))
 ...
 */
export const Includes = (...args: Parameters<ReturnType<typeof z.string>['includes']>) =>
  ZodFn('Includes', t => (t as z.ZodString).includes(...args))
 ...
 */
export const IsString = (...args: Parameters<typeof z.string>) =>
  Zod(opts => z.string(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsNumber = (...args: Parameters<typeof z.number>) =>
  Zod(opts => z.number(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsBigint = (...args: Parameters<typeof z.bigint>) =>
  Zod(opts => z.bigint(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsBoolean = (...args: Parameters<typeof z.boolean>) =>
  Zod(opts => z.boolean(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsDate = (...args: Parameters<typeof z.date>) =>
  Zod(opts => z.date(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsSymbol = (...args: Parameters<typeof z.symbol>) =>
  Zod(opts => z.symbol(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsUndefined = (...args: Parameters<typeof z.undefined>) =>
  Zod(opts => z.undefined(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsNull = (...args: Parameters<typeof z.null>) =>
  Zod(opts => z.null(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsVoid = (...args: Parameters<typeof z.void>) =>
  Zod(opts => z.void(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsAny = (...args: Parameters<typeof z.any>) =>
  Zod(opts => z.any(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsUnknown = (...args: Parameters<typeof z.unknown>) =>
  Zod(opts => z.unknown(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsNever = (...args: Parameters<typeof z.never>) =>
  Zod(opts => z.never(...(opts ? [{ ...args[0], ...opts }, ...args.slice(1)] : args)))
 ...
 * @returns Zod Type decorator
 */
export const IsTuple = (schemas: Array<TFunction | z.ZodType | TPrimitives>) =>
  Zod(z.tuple(schemas.map(s => toZodType(s)) as [z.ZodTypeAny, ...z.ZodTypeAny[]]))
...
) => Zod(z.map(toZodType(type), toZodType(type2)))
...
export const IsUnion = (
  ...types: [
    TFunction | z.ZodType | TPrimitives,
    TFunction | z.ZodType | TPrimitives,
    ...Array<TFunction | z.ZodType | TPrimitives>,
  ]
) =>
  Zod(
    z.union(
      types.map(t => toZodType(t)) as unknown as readonly [
        z.ZodTypeAny,
        z.ZodTypeAny,
        ...z.ZodTypeAny[],
      ]
...
export const IsDiscriminatedUnion = (
  ...
  Zod(
    z.discriminatedUnion(
      discriminator,
      options.map(t => toZodType(t)) as unknown as [
...
export const IsIntersection = (
  left: TFunction | z.ZodType | TPrimitives,
  right: TFunction | z.ZodType | TPrimitives
) => Zod(z.intersection(toZodType(left), toZodType(right)))
 ...
 * @returns Zod Type decorator
 */
export const IsPromise = (type: TFunction | z.ZodType | TPrimitives) =>
  Zod(z.promise(toZodType(type)))
...
export const ToNumber = () =>
  Preprocess((val: unknown) => (typeof val === 'string' && !!val ? Number(val) : val))
...
export const ToBoolean = (
  truthful: unknown[] = ['true', 'True', 'TRUE', 1],
  falsy: unknown[] = ['false', 'False', 'FALSE', 0]
) =>
  Preprocess((val: unknown) => {
    if (typeof val === 'boolean') {
      return val
    }
    if (truthful.includes(val)) {
      return true
    }
 ...
 * @returns Zod Type decorator
 */
export const And = (type: TFunction | z.ZodType | TPrimitives) =>
  ZodFn('And', t => t.and(toZodType(type)))
 ...
 * @returns Zod Type decorator
 */
export const Or = (type: TFunction | z.ZodType | TPrimitives) =>
  ZodFn('Or', t => t.or(toZodType(type)))
...
function toZodType(type: TFunction | z.ZodType | TPrimitives, opts?: TZodOpts): z.ZodType {
  ...
  if (typeof type === 'string') {
    return resolveZodPrimitive(type)
  }
